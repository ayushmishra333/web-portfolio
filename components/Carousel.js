...
const images = [
  ...
  { src: web6, title: "E-commerce Website", type: "github", link: "https://github.com/ayushmishra333/little-lemon", description: "This project showcases a responsive React app for a restaurant, focusing on user engagement, easy reservations, and seamless experience using semantic HTML and modern CSS." },
...
const Carousel = () => {
  ...
  const handlers = useSwipeable({
    ...
    trackMouse: true,  // Enables swipe on desktop as well
  });
