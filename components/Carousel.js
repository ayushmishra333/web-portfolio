...
//       <AiOutlineLeft onClick={prevSlide} className="absolute left-0 text-3xl cursor-pointer select-none" />
//       <AiOutlineRight onClick={nextSlide} className="absolute right-0 text-3xl cursor-pointer select-none" />
